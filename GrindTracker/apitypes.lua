...
UIEVENT_TYPE = {
    ...
    UPDATE_MAIN_MENU_EXPEDITION = "UPDATE_MAIN_MENU_EXPEDITION",
    ...
    UPDATE_HIDE_OPTIMIZATION_BUTTON = "UPDATE_HIDE_OPTIMIZATION_BUTTON",
    OPTIMIZATION_BUTTON_MESSAGE = "OPTIMIZATION_BUTTON_MESSAGE",
    ...
    RANDOM_SHOP_OPEN_HOT_KEY = "RANDOM_SHOP_OPEN_HOT_KEY",
